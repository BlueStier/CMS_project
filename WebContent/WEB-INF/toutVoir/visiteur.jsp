...
<body>
	<div class="container-fluid">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">Voir tout les visiteurs</li>
		</ol>
		<!-- Icon Cards-->

		<%
			DAO<?> u = DAOFactory.getVisiteursDAO();
			ArrayList<Visiteurs> liste = (ArrayList<Visiteurs>) u.get_all();
				...
				<div class="form-group">
					<div class="form-row">
						<div class="col-md-6">
							...
							<input type="hidden" name="modifVis"
								value="<%=liste.get(i).get_id()%>">
							<button class="btn btn-primary btn-block" name="confModifVis">Modifier</button>
						</div>
						<div class="col-md-6">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<input type="hidden" name="supVis"
							value="<%=liste.get(i).get_id()%>"></input>
						<button class="btn btn-primary" type="submit" name="confSupVis">Supprimer</button>
					</div>
				</div>
			</div>
		</div>
